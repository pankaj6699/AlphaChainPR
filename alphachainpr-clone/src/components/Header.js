        ...
        <div className="flex justify-between items-center py-6 lg:py-8">
          ...
          <nav className="hidden lg:flex items-center justify-center flex-1 mx-8 xl:mx-12">
            <div className="flex items-center space-x-4 xl:space-x-6">
              <a href="#home" className="relative group font-medium text-white/90 hover:text-white transition-all duration-300 px-3 py-2 text-sm xl:text-base">
                Home
                <span className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="C:\Users\Lenovo\Desktop\AlphaChainPR\alphachainpr-clone\src\components\AboutPage.js" className="relative group font-medium text-white/90 hover:text-white transition-all duration-300 px-3 py-2 text-sm xl:text-base">
                About
                <span className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#services" className="relative group font-medium text-white/90 hover:text-white transition-all duration-300 px-3 py-2 text-sm xl:text-base">
                Services
                <span className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#portfolio" className="relative group font-medium text-white/90 hover:text-white transition-all duration-300 px-3 py-2 text-sm xl:text-base">
                Portfolio
                <span className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#contact" className="relative group font-medium text-white/90 hover:text-white transition-all duration-300 px-3 py-2 text-sm xl:text-base">
                Contact
                <span className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-300 group-hover:w-full"></span>
              </a>
            </div>
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-8 pt-6 border-t border-white/20 animate-fade-in-up">
            <nav className="flex flex-col space-y-4 mb-6">
              <a href="#home" className="block py-3 px-4 text-white/90 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-300 font-medium" onClick={() => setIsMenuOpen(false)}>
                Home
              </a>
              <a href="#about" className="block py-3 px-4 text-white/90 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-300 font-medium" onClick={() => setIsMenuOpen(false)}>
                About
              </a>
              <a href="#services" className="block py-3 px-4 text-white/90 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-300 font-medium" onClick={() => setIsMenuOpen(false)}>
                Services
              </a>
              <a href="#portfolio" className="block py-3 px-4 text-white/90 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-300 font-medium" onClick={() => setIsMenuOpen(false)}>
                Portfolio
              </a>
              <a href="#contact" className="block py-3 px-4 text-white/90 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-300 font-medium" onClick={() => setIsMenuOpen(false)}>
                Contact
              </a>
            </nav>
            ...
            <div className="pt-6 border-t border-white/20 space-y-4">
              <div className="px-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg px-4 py-3">
                    ...
                    <span className="text-white/90">hello@alphachainpr.com</span>
                  </div>
                </div>
              </div>
              ...
              <div className="px-4">
                ...
                <div className="flex items-center space-x-3">
                  <a href="https://twitter.com/alphachainpr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full flex items-center justify-center hover:bg-blue-500/20 hover:border-blue-400/50 transition-all duration-300">
                  ...
                  <a href="https://linkedin.com/company/alphachainpr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full flex items-center justify-center hover:bg-blue-600/20 hover:border-blue-500/50 transition-all duration-300">
                  ...
                  <a href="https://discord.gg/alphachainpr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full flex items-center justify-center hover:bg-indigo-600/20 hover:border-indigo-500/50 transition-all duration-300">
                  ...
                  <a href="https://t.me/alphachainpr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full flex items-center justify-center hover:bg-blue-500/20 hover:border-blue-400/50 transition-all duration-300">
                    <svg className="w-5 h-5 text-white/80 hover:text-blue-400 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/>
                    </svg>
                  </a>
